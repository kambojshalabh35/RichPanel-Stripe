              ...
              <tr>
                ...
                <td
                  className={`text-center ${
                    PlanHandler == "mobile" ? styles.tbBodySelected : ""
                  }`}
                >
                    {
                ...
                <td
                  className={`text-center ${
                    PlanHandler == "basic" ? styles.tbBodySelected : ""
                  }`}
                >
                    {
                ...
                <td
                  className={`text-center ${
                    PlanHandler == "standard" ? styles.tbBodySelected : ""
                  }`}
                >
                    {
                ...
                <td
                  className={`text-center ${
                    PlanHandler == "premium" ? styles.tbBodySelected : ""
                  }`}
                >
                    {
